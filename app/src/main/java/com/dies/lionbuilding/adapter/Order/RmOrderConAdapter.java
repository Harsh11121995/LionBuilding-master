...
public class RmOrderConAdapter extends RecyclerView.Adapter<RmOrderConAdapter.MyViewHolder> {
    ...
    public RmOrderConAdapter(Context context, List<OrderConData.Data> dataList) {
    ...
    @NonNull
    @Override
    public RmOrderConAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rm_ordercon_details, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.btn_confrm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Observable<OrderConData> responseObservable = apiservice.get_rm_distrbtr_odrconfirm(
   ...
   /* public void updateData(List<OrderConData.Data> viewModels) {
       // dataList.clear();
        dataList.addAll(viewModels);
