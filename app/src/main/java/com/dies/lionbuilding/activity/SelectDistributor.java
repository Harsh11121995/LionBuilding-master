...
public class SelectDistributor extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void getUsersList() {
        ...
        Observable<NewUserModel> responseObservable = apiservice.getDistributor();
                ...
                .subscribe(new Observer<NewUserModel>() {
                    ...
                    public void onNext(NewUserModel newUserModel) {//
                        ...
                        if (statusCode == 200) {
                            ...
                            adapter = new ArrayAdapter<String>(SelectDistributor.this, android.R.layout.simple_list_item_1, array);
