...
public class GetLocation extends BroadcastReceiver{
    ...
    private void updateLocationUI(Context context) {
...
//            );
            ...
            Log.i("sendlocation","Every 5 minutes it will appear in Log Console"+mCurrentLocation.getLatitude()+" "+mCurrentLocation.getLongitude());
        }
